...
public class QueryHelperMMM {
    ...
    public QueryHelperMMM(Anno4j anno4j) {
        this.anno4j = anno4j;
    }
     ...
     */
    public QueryHelperMMM filterBodyType(String type) {
     ...
     */
    public QueryHelperMMM filterSelectorType(String type) {
     ...
     */
    public QueryHelperMMM filterTargetType(String type) {
