...
class ConfigurationDiscoverEvent;
...
class ConfigurationEvent : public ::google::protobuf::Message {
 public:
  ConfigurationEvent();
  ...
  void Swap(ConfigurationEvent* other);

  // implements Message ----------------------------------------------

  ConfigurationEvent* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  ...
  inline bool has_marmottabaseuri() const;
  inline void clear_marmottabaseuri();
  static const int kMarmottaBaseUriFieldNumber = 1;
  inline const ::std::string& marmottabaseuri() const;
  inline void set_marmottabaseuri(const ::std::string& value);
  inline void set_marmottabaseuri(const char* value);
  inline void set_marmottabaseuri(const char* value, size_t size);
  inline ::std::string* mutable_marmottabaseuri();
  inline ::std::string* release_marmottabaseuri();
  inline void set_allocated_marmottabaseuri(::std::string* marmottabaseuri);

  // required string storageBaseUri = 2;
  inline bool has_storagebaseuri() const;
  inline void clear_storagebaseuri();
  static const int kStorageBaseUriFieldNumber = 2;
  inline const ::std::string& storagebaseuri() const;
  inline void set_storagebaseuri(const ::std::string& value);
  inline void set_storagebaseuri(const char* value);
  inline void set_storagebaseuri(const char* value, size_t size);
  inline ::std::string* mutable_storagebaseuri();
  inline ::std::string* release_storagebaseuri();
  inline void set_allocated_storagebaseuri(::std::string* storagebaseuri);

  // @@protoc_insertion_point(class_scope:mico.event.model.ConfigurationEvent)
 private:
  inline void set_has_marmottabaseuri();
  inline void clear_has_marmottabaseuri();
  inline void set_has_storagebaseuri();
  inline void clear_has_storagebaseuri();

  ::google::protobuf::UnknownFieldSet _unknown_fields_;

  ::google::protobuf::uint32 _has_bits_[1];
  mutable int _cached_size_;
  ::std::string* marmottabaseuri_;
  ::std::string* storagebaseuri_;
  friend void  protobuf_AddDesc_Event_2eproto();
  friend void protobuf_AssignDesc_Event_2eproto();
  friend void protobuf_ShutdownFile_Event_2eproto();

  void InitAsDefaultInstance();
  static ConfigurationEvent* default_instance_;
};
// -------------------------------------------------------------------

class ConfigurationDiscoverEvent : public ::google::protobuf::Message {
 public:
  ConfigurationDiscoverEvent();
  virtual ~ConfigurationDiscoverEvent();

  ConfigurationDiscoverEvent(const ConfigurationDiscoverEvent& from);

  inline ConfigurationDiscoverEvent& operator=(const ConfigurationDiscoverEvent& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const ConfigurationDiscoverEvent& default_instance();

  void Swap(ConfigurationDiscoverEvent* other);

  // implements Message ----------------------------------------------

  ConfigurationDiscoverEvent* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const ConfigurationDiscoverEvent& from);
  void MergeFrom(const ConfigurationDiscoverEvent& from);
  void Clear();
  bool IsInitialized() const;
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static ConfigurationDiscoverEvent* default_instance_;
};
// ===================================================================
...
// required string marmottaBaseUri = 1;
inline bool ConfigurationEvent::has_marmottabaseuri() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void ConfigurationEvent::set_has_marmottabaseuri() {
  _has_bits_[0] |= 0x00000001u;
}
inline void ConfigurationEvent::clear_has_marmottabaseuri() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void ConfigurationEvent::clear_marmottabaseuri() {
  if (marmottabaseuri_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    marmottabaseuri_->clear();
  }
  clear_has_marmottabaseuri();
}
inline const ::std::string& ConfigurationEvent::marmottabaseuri() const {
  // @@protoc_insertion_point(field_get:mico.event.model.ConfigurationEvent.marmottaBaseUri)
  return *marmottabaseuri_;
}
inline void ConfigurationEvent::set_marmottabaseuri(const ::std::string& value) {
  set_has_marmottabaseuri();
  if (marmottabaseuri_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    marmottabaseuri_ = new ::std::string;
  }
  marmottabaseuri_->assign(value);
  // @@protoc_insertion_point(field_set:mico.event.model.ConfigurationEvent.marmottaBaseUri)
}
inline void ConfigurationEvent::set_marmottabaseuri(const char* value) {
  set_has_marmottabaseuri();
  if (marmottabaseuri_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    marmottabaseuri_ = new ::std::string;
  }
  marmottabaseuri_->assign(value);
  // @@protoc_insertion_point(field_set_char:mico.event.model.ConfigurationEvent.marmottaBaseUri)
}
inline void ConfigurationEvent::set_marmottabaseuri(const char* value, size_t size) {
  set_has_marmottabaseuri();
  if (marmottabaseuri_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    marmottabaseuri_ = new ::std::string;
  }
  marmottabaseuri_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:mico.event.model.ConfigurationEvent.marmottaBaseUri)
}
inline ::std::string* ConfigurationEvent::mutable_marmottabaseuri() {
  set_has_marmottabaseuri();
  if (marmottabaseuri_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    marmottabaseuri_ = new ::std::string;
  }
  // @@protoc_insertion_point(field_mutable:mico.event.model.ConfigurationEvent.marmottaBaseUri)
  return marmottabaseuri_;
}
inline ::std::string* ConfigurationEvent::release_marmottabaseuri() {
  clear_has_marmottabaseuri();
  if (marmottabaseuri_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    return NULL;
  } else {
    ::std::string* temp = marmottabaseuri_;
    marmottabaseuri_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
    return temp;
  }
}
inline void ConfigurationEvent::set_allocated_marmottabaseuri(::std::string* marmottabaseuri) {
  if (marmottabaseuri_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete marmottabaseuri_;
  }
  if (marmottabaseuri) {
    set_has_marmottabaseuri();
    marmottabaseuri_ = marmottabaseuri;
  } else {
    clear_has_marmottabaseuri();
    marmottabaseuri_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  }
  // @@protoc_insertion_point(field_set_allocated:mico.event.model.ConfigurationEvent.marmottaBaseUri)
}

// required string storageBaseUri = 2;
inline bool ConfigurationEvent::has_storagebaseuri() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void ConfigurationEvent::set_has_storagebaseuri() {
  _has_bits_[0] |= 0x00000002u;
}
inline void ConfigurationEvent::clear_has_storagebaseuri() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void ConfigurationEvent::clear_storagebaseuri() {
  if (storagebaseuri_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    storagebaseuri_->clear();
  }
  clear_has_storagebaseuri();
}
inline const ::std::string& ConfigurationEvent::storagebaseuri() const {
  // @@protoc_insertion_point(field_get:mico.event.model.ConfigurationEvent.storageBaseUri)
  return *storagebaseuri_;
}
inline void ConfigurationEvent::set_storagebaseuri(const ::std::string& value) {
  set_has_storagebaseuri();
  if (storagebaseuri_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    storagebaseuri_ = new ::std::string;
  }
  storagebaseuri_->assign(value);
  // @@protoc_insertion_point(field_set:mico.event.model.ConfigurationEvent.storageBaseUri)
}
inline void ConfigurationEvent::set_storagebaseuri(const char* value) {
  set_has_storagebaseuri();
  if (storagebaseuri_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    storagebaseuri_ = new ::std::string;
  }
  storagebaseuri_->assign(value);
  // @@protoc_insertion_point(field_set_char:mico.event.model.ConfigurationEvent.storageBaseUri)
}
inline void ConfigurationEvent::set_storagebaseuri(const char* value, size_t size) {
  set_has_storagebaseuri();
  if (storagebaseuri_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    storagebaseuri_ = new ::std::string;
  }
  storagebaseuri_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:mico.event.model.ConfigurationEvent.storageBaseUri)
}
inline ::std::string* ConfigurationEvent::mutable_storagebaseuri() {
  set_has_storagebaseuri();
  if (storagebaseuri_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    storagebaseuri_ = new ::std::string;
  }
  // @@protoc_insertion_point(field_mutable:mico.event.model.ConfigurationEvent.storageBaseUri)
  return storagebaseuri_;
}
inline ::std::string* ConfigurationEvent::release_storagebaseuri() {
  clear_has_storagebaseuri();
  if (storagebaseuri_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    return NULL;
  } else {
    ::std::string* temp = storagebaseuri_;
    storagebaseuri_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
    return temp;
  }
}
inline void ConfigurationEvent::set_allocated_storagebaseuri(::std::string* storagebaseuri) {
  if (storagebaseuri_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete storagebaseuri_;
  }
  if (storagebaseuri) {
    set_has_storagebaseuri();
    storagebaseuri_ = storagebaseuri;
  } else {
    clear_has_storagebaseuri();
    storagebaseuri_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  }
  // @@protoc_insertion_point(field_set_allocated:mico.event.model.ConfigurationEvent.storageBaseUri)
}
