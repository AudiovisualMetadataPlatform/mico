...
namespace mico {
  namespace hdfs {
    ...
    class HDFSDevice : public boost::iostreams::seekable_device {
    private:
    ...
    public:
       ...
       */
      HDFSDevice(hdfsFS hdfsHandle, const char* filename, int flags, int bufferSize = 0, short replication = 0, int blockSize = 0);
