...
//        Mockito.when(states.get(Matchers.any())).thenReturn(state);
...
//        Mockito.when(persistenceService.getContentItem(Matchers.<URI>any())).thenAnswer(new Answer<ContentItem>(){
//            @Override
...
//        Mockito.when(metadata.query(Matchers.anyString())).thenAnswer(new Answer<TupleQueryResult>() {
//            @Override
