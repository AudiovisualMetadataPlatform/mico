...
public class RecoWebServiceTest {
    ...
    @Test
    public void testTalkanalysisRating() throws Exception {

        RestAssured.
                when()
                .post(server.getUrl() + "reco/zoo/12345/discussion/relatedsubjects")
                .then()
                .assertThat()
                .statusCode(202);
    }
    ...
    public void testEditorSupport() throws Exception {
        ...
        RestAssured.when()
                .get(server.getUrl() + "reco/gp/editorsupport/12345")
                .then()
                .assertThat()
                .statusCode(200)
                .body("reco_id", Matchers.equalTo("12345"));
    ...
    @Test
    public void testEditorSupportRating() throws Exception {

        RestAssured.when()
                .post(server.getUrl() + "reco/gp/editorsupport/12345")
                .then()
                .assertThat()
                .statusCode(202);
    }
    ...
    @Test
    public void testAddEntityInteraction() throws Exception {

        RestAssured.when()
                .post(server.getUrl() + "reco/gp/interactions/entity_id/target_id")
                .then()
                .assertThat()
                .statusCode(201);
    }
    ...
    @Test
    public void testDeleteEntityInteraction() throws Exception {

        RestAssured.when()
                .delete(server.getUrl() + "reco/gp/interactions/entity_id/target_id")
                .then()
                .assertThat()
                .statusCode(200);
    }
    ...
    @Test
    public void testSimpleRecommendation() throws Exception {

        RestAssured.when()
                .get(server.getUrl() + "reco/gp/entity_id?user_id=user_id&limit=limit")
                .then()
                .assertThat()
                .statusCode(200);
    }
    ...
    @Test
    public void testRecommendationRating() throws Exception {

        RestAssured.when()
                .post(server.getUrl() + "reco/gp/entity_id?user_id=user_id")
                .then()
                .assertThat()
                .statusCode(202);
    }
